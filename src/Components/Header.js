        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className=" colorText" href="/Productos">
                Has tu petición
              </a>
            </li>
            <li className="nav-item">
              <a className=" colorText" href="/Materiales">
                Materiales
              </a>
            </li>
          ...
          <li className="nav-item">
              <a className="colorText " href="/CarritodeCompras">
                <svg
            ...
            <li className="nav-item">
              <a className="btn btn-dark" href="/" onClick={handleLogout}>
                Logout
              </a>
            </li>
          </ul>
